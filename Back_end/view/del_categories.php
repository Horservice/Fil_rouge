<?php $title = "supprimer une catégorie"; ?>
<?php ob_start(); ?>
...
<h4><?=$msg?></h4>
        ...
        <form action="" method="POST" class="row my-5" enctype="multipart/form-data">
            ...
            <div class="container bg-primary-subtle rounded-5 text-center py-5">
                <p class="py-2 bg-warning-subtle rounded-5 my-3 py-3">Voules vous vraiment supprimer : <?=$categories['name']?> ?</p>
            </div>

            
            <div class="container pt-5">
                <a type="button" class="btn btn-light" href="index.php?page=management_categories">Retour</a>
